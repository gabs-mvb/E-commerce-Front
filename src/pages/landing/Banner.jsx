import BannerZero from "./../../assets/lading/banner-0.jpg";
import BannerOne from "./../../assets/lading/banner-1.jpg";
import BannerTwo from "./../../assets/lading/banner-2.jpg";
  ...
  return (
    ...
    >
      ...
      <div className="carousel-caption d-none d-lg-block">
        <h5>Ragnar Outlet</h5>
        <p>Encontre o melhor do outlet aqui.</p>
      </div>
    </div>
  );
}
